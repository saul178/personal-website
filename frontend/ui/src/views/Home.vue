  ...
  <div class="px-6 py-12 flex flex-col md:flex-row md:items-start md:space-x-32 space-y-16
    ...
    <div class="px-6 py-12 flex flex-wrap justify-center gap-8
      ...
      <div class="flex flex-col space-y-6">
        <div class="group hover:-translate-y-1 bg-foreground hover:bg-foreground/60 backdrop-blur-sm
          ...
          <div class="flex items-start gap-4 mt-3">
            ...
            <div class="flex flex-col gap-2 items-center md:items-start">
              <div>
                <div class="text-3xl font-semibold dark:text-primary text-center
                  md:text-start">OS's
                </div>
                <div class="text-xl dark:text-secondary text-center
                  md:text-start">Linux main, but will touch these reluctantly
                </div>
              </div>

              <div class="flex flex-wrap gap-2 items-center justify-center border-t-2
                dark:border-background hover:border-accent/50 transition-colors">
        ...
        <div class="flex flex-col space-y-6 w-full max-w-2xl">
          <div class="dark:bg-foreground rounded-2xl shadow-lg p-6 w-full max-w-2xl text-center">
            <h1 class="text-lg font-medium dark:text-primary"> Proficient in these languages </h1>
        ...
        <div class="flex flex-col space-y-6 w-full max-w-2xl">
          <div class="dark:bg-foreground rounded-2xl shadow-lg p-6 w-full max-w-2xl text-center">
            <h1 class="text-lg font-medium dark:text-primary"> Proficient with these
              technologies </h1>
            <div class="flex items-start gap-4 mt-3">
              <div class="hidden md:flex flex-col items-center pt-12 px-3">
        ...
        <div class="flex flex-col space-y-6 w-full max-w-2xl">
          <div class="dark:bg-foreground rounded-2xl shadow-lg p-6 w-full max-w-2xl text-center">
            <h1 class="text-lg font-medium dark:text-primary"> Proficient with these frameworks </h1>
            <div class="flex items-start gap-4 mt-3">
              <div class="hidden md:flex flex-col items-center pt-12 px-3">
              ...
              <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mt-4 w-full">
                ...
                <div class="dark:bg-background p-3 rounded-lg shadow-md shadow-satin-sheen-gold-500 text-center">
                  <svg viewBox="0 0 15 15" fill="none" class="w-12 h-12 mx-auto dark:text-primary"
                  ...
                  <span class="dark:text-primary block mt-1"> Tailwind CSS </span>
                </div>
                <div class="dark:bg-background p-3 rounded-lg shadow-md shadow-satin-sheen-gold-500 text-center">
                  <svg fill="#000000" viewBox="0 0 32 32" class="dark:text-primary w-12 h-12 mx-auto"
                    xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
        ...
        <div class="flex flex-col space-y-6 w-full max-w-2xl">
          <div class="dark:bg-foreground rounded-2xl shadow-lg p-6 w-full max-w-2xl text-center">
            <h1 class="text-lg font-medium dark:text-primary"> Experienced with these
              databases </h1>
            <div class="flex items-start gap-4 mt-3">
              <div class="hidden md:flex flex-col items-center pt-12 px-3">
              ...
              <div class="grid grid-cols-2 md:grid-cols-3 gap-4 mt-4 w-full">
                <div class="dark:bg-background p-3 rounded-lg shadow-md shadow-satin-sheen-gold-500 text-center">
                  <svg fill="currentColor" viewBox="0 0 24 24" class="dark:text-primary w-16 h-16 mx-auto"
                ...
                <div class="dark:bg-background p-3 rounded-lg shadow-md shadow-satin-sheen-gold-500 text-center">
                  <svg fill="currentColor" viewBox="0 0 32 32" class="dark:text-primary w-16 h-16 mx-auto"
                    xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
                ...
                <div class="dark:bg-background p-3 rounded-lg shadow-md shadow-satin-sheen-gold-500 text-center">
                  <svg fill="currentColor" class="dark:text-primary w-16 h-16 mx-auto" viewBox="0 0 32 32" version="1.1"
                    xmlns="http://www.w3.org/2000/svg">
                    <g id="SVGRepo_bgCarrier" stroke-width="0"></g>
                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                    <g id="SVGRepo_iconCarrier">
